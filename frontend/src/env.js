...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_FOLLOWUP_SUGGESTIONS_ENABLED: z.string().optional(),
  },
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_FOLLOWUP_SUGGESTIONS_ENABLED:
      process.env.NEXT_PUBLIC_FOLLOWUP_SUGGESTIONS_ENABLED,
